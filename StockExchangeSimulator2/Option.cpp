...
Option::Option(int id, int id_seller, int id_stock, int maturity, double strike ,bool is_call,double price,double delta)
{
    _id = id;
    ...
    _strike = strike;
    _is_call = is_call;
    _number_of_stocks = 100;//convention!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    _price = price;
    _offer = price;
    _exercice = false;
    _sold = false;//indicates if initial money<->option transfer was made
    _delta = delta;
    _time = 0;
...
void Option::SetDelta(double delta)
{
    _delta = delta;
}
